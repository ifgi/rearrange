...
Rdata:
* fijisub.Rdata: the small sub-array of fiji array. the longitude and latitude are flattened into one dimension. The arry size is ($259 \times 150 \times 6$), which corresponds to (number of $pixels \times time \times spectral bands$)
dim(fijisub)
[1] 259 150   6
